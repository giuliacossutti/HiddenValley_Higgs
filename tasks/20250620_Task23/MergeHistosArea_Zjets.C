...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/MergeHistosArea_Zjets.C 
...
void MergeHistosArea_Zjets()
{
  ...
  // Import histograms 
  TString sampledir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250620_Task23/";
