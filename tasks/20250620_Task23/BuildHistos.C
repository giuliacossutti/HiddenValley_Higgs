...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/BuildHistos.C'("signal_EJ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250620_Task23/BuildHistos.C'("bkg_HZ_SM")' &
...
void BuildHistos(const char *inFile)
{
  ...
  for(Int_t entry = 0; entry < numberOfEntries; ++entry)
  {
    ...
    //-------------------- End of Preselection -------------------------
     ...
     if(n_largejets == 1){
       A_N_bsmall->Fill(n_bsmalljets);
       A_Nsmall_Nbsmall->Fill(n_smalljets,n_bsmalljets);
       A_DeltaR_small->Fill( DeltaR(smalljet1, smalljet2) );
     }else if(n_largejets >= 2){
       B_N_bsmall->Fill(n_bsmalljets);
       B_Nsmall_Nbsmall->Fill(n_smalljets,n_bsmalljets);
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form("/gfsvol01/atlas/giuliac/plots_and_outputs/20250620_Task23/%s.root",inFile);
