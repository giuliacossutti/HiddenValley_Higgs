...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250622_Task24/MergeHistosArea_ZZHZ.C 
...
void MergeHistosArea_ZZHZ()
{

  gSystem->Load("libDelphes");

  // Import histograms 
  TString sampledir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250622_Task24/";
  ...
  Double_t xsec_sig = xsec_bkgZZ + xsec_bkgHZ;
  ...
  std::vector<TFile*> infiles = {f_sig,f_bkgHZ,f_bkgZZ};
  std::vector<Color_t> colors = {kBlack,kAzure+5,kGreen+1};
  //std::vector<TString> legentry = {TString::Format("f #bar{f} -> H Z -> qv1 #bar{qv1} l^{+} l^{-}, #sigma = %.0f pb",xsec_sig),TString::Format("HZ -> b #bar{b} l^{+} l^{-}, #sigma = %.4f pb",xsec_bkgHZ),TString::Format("ZZ, #sigma = %.3f pb",xsec_bkgZZ)};
  std::vector<TString> legentry = {TString::Format("f #bar{f} -> H Z -> qv1 #bar{qv1} l^{+} l^{-}, Area = #Sigma Bkgs"),TString::Format("HZ -> b #bar{b} l^{+} l^{-}, #sigma = %.4f pb",xsec_bkgHZ),TString::Format("ZZ, #sigma = %.3f pb",xsec_bkgZZ)};
  ...
  std::vector<Double_t> xsec = {xsec_sig,xsec_bkgHZ,xsec_bkgZZ};
  std::vector<Double_t> ntot = {ntot_sig,ntot_bkgHZ,ntot_bkgZZ};
  ...
  std::array<Double_t,4> leglimits_1 = {0.461153,0.543403,0.77193,0.868056};
