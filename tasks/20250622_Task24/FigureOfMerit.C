...
signal is scaled with area = sum of ZZ, SM HZ bkgs areas.
Histograms have been saved in files in 20250622_Task24.

From inside the /gfsvol01/atlas/giuliac/HiggsTutorial/MG5_aMC_v3_5_6/Delphes directory run with
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250622_Task24/FigureOfMerit.C 
...
void FigureOfMerit()
{
  ...
  TString filename = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250622_Task24/area_ZZHZ_MergedHistos.root";

  TFile *infile = new TFile(filename);

  // Output directory
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250622_Task24/ZZHZ_Cut4_";
