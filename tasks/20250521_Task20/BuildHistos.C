...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250521_Task20/BuildHistos.C'("signal_EJ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250521_Task20/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250521_Task20/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250521_Task20/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250521_Task20/BuildHistos.C'("bkg_HZ_SM")' &
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form("/gfsvol01/atlas/giuliac/plots_and_outputs/20250521_Task20/%s.root",inFile);
