...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250710_Task25/Chi2_MergeHistos.C 
...
void Chi2_MergeHistos()
{
  ...
  // Import histograms 
  TString dir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250710_Task25/";
  ...
  for(Double_t i = 0.1; i < 0.32; i += 0.02){
    xsec_s1.push_back(i);
  }

  std::vector<Double_t> xsec_s2;
  for(Double_t i = 0.09; i < 0.122; i += 0.002){
    xsec_s2.push_back(i);
  }
