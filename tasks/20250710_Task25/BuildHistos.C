...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250710_Task25/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250710_Task25/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250710_Task25/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250710_Task25/BuildHistos.C'("bkg_HZ_SM")' &
...
void BuildHistos(const char *inFile)
{
  ...
  if( (std::strcmp(inFile,"signal_EJ") == 0) || (std::strcmp(inFile,"bkg_ZZ") == 0) || (std::strcmp(inFile,"bkg_HZ_SM") == 0) ){
  ...
  if( (std::strcmp(inFile,"bkg_Zjets_q") == 0) || (std::strcmp(inFile,"bkg_Zjets_g") == 0) ){
    for (Int_t i = 1; i <= 100; i++){
      inname.Form("/eos/infnts/atlas/giuliac/condor/20250709_Task25/root_outputs/50K_%s_%d.root",inFile,i);
      chain.Add(inname);
      cout << "File " << inname << " added to chain." << endl;
    }
  }
...
*/
  ...
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250710_Task25/" ;
  ...
  outtextfile << "This file contains Number of Events passing selection after Cut4 for sample " << inFile << endl;
  outtextfile << "" << endl;
