...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/MergeHistosArea_Zjets.C 
...
void MergeHistosArea_Zjets()
{

  gSystem->Load("libDelphes");

  // Import histograms 
  TString sampledir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250611_Task22/";
  ...
  std::vector<TFile*> infiles = {f_sig,f_bkgZg,f_bkgZq};
  std::vector<Color_t> colors = {kBlack,kMagenta-10,kOrange-8};
  std::vector<TString> legentry = {TString::Format("f #bar{f} -> H Z -> qv1 #bar{qv1} l^{+} l^{-}, Area = #Sigma Bkgs"),TString::Format("Z + jets (g), #sigma = %.0f pb",xsec_bkgZg),TString::Format("Z + jets (q), #sigma = %.0f pb",xsec_bkgZq)};
  ...
  std::vector<Double_t> xsec = {xsec_sig,xsec_bkgZg,xsec_bkgZq};
  std::vector<Double_t> ntot = {ntot_sig,ntot_bkgZg,ntot_bkgZq};
  ...
  std::array<Double_t,4> leglimitsInvmassS = {0.452381,0.564236,0.763158,0.875};
  DrawHistos(infiles,"Invariant_mass_of_leading_and_subleading_small_jets",weights,colors,"m_{jj} [GeV/c^{2}]","#events",leglimitsInvmassS,"m_{jj} of first 2 Small Jets",legentry,"InvMass_small",sampledir);
  //DrawHistosStack(infiles,"Invariant_mass_of_leading_and_subleading_small_jets",weights,colors,"m_{jj} [GeV/c^{2}]","#events",leglimitsInvmassS,"m_{jj} of first 2 Small Jets",legentry,"InvMass_small",sampledir);

  std::array<Double_t,4> leglimitsInvmassL = {0.452381,0.564236,0.763158,0.875};
  DrawHistos(infiles,"Invariant_mass_of_leading_and_subleading_large_jets",weights,colors,"m_{jj} [GeV/c^{2}]","#events",leglimitsInvmassL,"m_{jj} of first 2 Large Jets",legentry,"InvMass_large",sampledir);
  //DrawHistosStack(infiles,"Invariant_mass_of_leading_and_subleading_large_jets",weights,colors,"m_{jj} [GeV/c^{2}]","#events",leglimitsInvmassL,"m_{jj} of first 2 Large Jets",legentry,"InvMass_large",sampledir);

  DrawHistos(infiles,"Invariant_mass_of_all_btagged_small_jets",weights,colors,"Invariant Mass [GeV/c^{2}]","#events",leglimitsInvmassS,"Invariant Mass of all b-tagged Small Jets",legentry,"InvMass_allb",sampledir);
  //DrawHistosStack(infiles,"Invariant_mass_of_all_btagged_small_jets",weights,colors,"Invariant Mass [GeV/c^{2}]","#events",leglimitsInvmassS,"Invariant Mass of all b-tagged Small Jets",legentry,"InvMass_allb",sampledir);

  std::array<Double_t,4> leglimitsDeltaR = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsDeltaPhi = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPT1S = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPT2S = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPT1L = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPT2L = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsNC1 = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsNC2 = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsNS = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsNbS = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsNL = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPTF1L = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPTF2L = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPTF1S = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPTF2S = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsPTF1bS = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsECF1L = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsECF2L = {0.452381,0.564236,0.763158,0.875};
  ...
  DrawHistos(infiles,"2point_Energy_Correlation_div_pT_of_leading_small_jet",weights,colors,"ECF2/pT [GeV/c]","# events",leglimitsECF1L,"ECF2/pT of Leading Small Jet",legentry,"ECF1S",sampledir);
  //DrawHistosStack(infiles,"2point_Energy_Correlation_div_pT_of_leading_small_jet",weights,colors,"ECF2/pT [GeV/c]","# events",leglimitsECF1L,"ECF2/pT of Leading Small Jet",legentry,"ECF1S",sampledir);

  DrawHistos(infiles,"2point_Energy_Correlation_div_pT_of_subleading_small_jet",weights,colors,"ECF2/pT [GeV/c]","# events",leglimitsECF2L,"ECF2/pT of Subleading Small Jet",legentry,"ECF2S",sampledir);
  //DrawHistosStack(infiles,"2point_Energy_Correlation_div_pT_of_subleading_small_jet",weights,colors,"ECF2/pT [GeV/c]","# events",leglimitsECF2L,"ECF2/pT of Subleading Small Jet",legentry,"ECF2S",sampledir);

  std::array<Double_t,4> leglimitsLepPT = {0.452381,0.564236,0.763158,0.875};
  ...
  std::array<Double_t,4> leglimitsLepR = {0.452381,0.564236,0.763158,0.875};
  ...
  DrawHistos2D(infiles,"IMsmall_vs_IMlarge",weights,"m_{jj} of first 2 Small Jets [GeV/c^2]","m_{jj} of first 2 Large Jets [GeV/c^2]","# events",leglimitsIMs_IMl,"m_{jj} of first 2 Small Jets vs m_{jj} of first 2 Large Jets",legentry,"IMs_IMl",sampledir);

  std::array<Double_t,4> leglimitsIMs_DRs = {0.235589,0.689236,0.546366,0.869792};
  DrawHistos2D(infiles,"IMsmall_vs_DeltaRsmall",weights,"m_{jj} of first 2 Small Jets [GeV/c^2]","#Delta R between first 2 Small Jets","# events",leglimitsIMs_DRs,"m_{jj} vs #Delta R of first 2 Small Jets",legentry,"IMs_DRs",sampledir);

  std::array<Double_t,4> leglimitsIMl_DRl = {0.235589,0.689236,0.546366,0.869792};
  DrawHistos2D(infiles,"IMlarge_vs_DeltaRlarge",weights,"m_{jj} of first 2 Large Jets [GeV/c^2]","#Delta R between first 2 Large Jets","# events",leglimitsIMl_DRl,"m_{jj} vs #Delta R of first 2 Large Jets",legentry,"IMl_DRl",sampledir);
