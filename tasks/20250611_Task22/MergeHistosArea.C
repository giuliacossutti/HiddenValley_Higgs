...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/MergeHistosArea.C 
...
void MergeHistosArea()
{
  ...
  DrawHistosStack(infiles,"Invariant_mass_of_leading_and_subleading_large_jets",weights,colors,"m_{jj} [GeV/c^{2}]","#events",leglimitsInvmassL,"m_{jj} Mass of first 2 Large Jets",legentry,"InvMass_large",sampledir);
