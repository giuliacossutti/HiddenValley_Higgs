...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/BuildHistos.C'("signal_EJ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250611_Task22/BuildHistos.C'("bkg_HZ_SM")' &
...
void BuildHistos(const char *inFile)
{
  ...
  TH1F *Invmass_bsmall = new TH1F("Invariant_mass_of_all_btagged_small_jets", "", 200, 0.0, 800.0);
  ...
  TH1F *ECF21_small = new TH1F("2point_Energy_Correlation_div_pT_of_leading_small_jet", "", 100, 0., 200.);
  TH1F *ECF22_small = new TH1F("2point_Energy_Correlation_div_pT_of_subleading_small_jet", "", 100, 0., 200.);
  ...
  for(Int_t entry = 0; entry < numberOfEntries; ++entry)
  {
    ...
    //-------------------- End of Preselection -------------------------
     ...
     if(index_bsmall >= 1){
       ...
       Invmass_bsmall->Fill( (alljetbP4).M() );
     }
     ...
     if(index_small >= 2){
       ...
       ECF21_small->Fill( ECF2small(treeReader, entry, branchTrack, smalljet1) / smalljet1->PT );
       ECF22_small->Fill( ECF2small(treeReader, entry, branchTrack, smalljet2) / smalljet2->PT );
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form("/gfsvol01/atlas/giuliac/plots_and_outputs/20250611_Task22/%s.root",inFile);
  ...
  Invmass_bsmall->Write("",TObject::kOverwrite);
  ...
  ECF21_small->Write("",TObject::kOverwrite);
  ECF22_small->Write("",TObject::kOverwrite);
