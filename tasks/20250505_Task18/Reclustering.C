...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250505_Task18/Reclustering.C'("/gfsvol01/atlas/giuliac/condor/20250505_Task18/50K_Higgs.root","Higgs",kTRUE)'
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250505_Task18/Reclustering.C'("/gfsvol01/atlas/giuliac/condor/20250505_Task18/50K_ReclpTmin40.root","ReclpTmin40",kTRUE)'
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250505_Task18/Reclustering.C'("/gfsvol01/atlas/giuliac/condor/20250505_Task18/50K_bbbar.root","bbbar",kTRUE)'
*/
...
void Reclustering(const char *inputFile, const char * outFile,Bool_t Norm=kFALSE)
{
  ...
  // Output name:
  TString outfolder;
  outfolder.Form("/gfsvol01/atlas/giuliac/plots_and_outputs/20250505_Task18/%s_",outFile);
