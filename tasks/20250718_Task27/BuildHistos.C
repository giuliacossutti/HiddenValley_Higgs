...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_HZ_SM")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_q_JES")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_g_JES")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_ZZ_JES")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_HZ_SM_JES")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_q_etrk")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_g_etrk")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_ZZ_etrk")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_HZ_SM_etrk")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_q_eb")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_Zjets_g_eb")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_ZZ_eb")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/BuildHistos.C'("bkg_HZ_SM_eb")' &
...
void BuildHistos(const char *inFile)
{
  ...
  for (Int_t i = 1; i <= 10; i++){
    inname.Form("/eos/infnts/atlas/giuliac/condor/20250717_Task27/root_outputs/50K_%s_%d.root",inFile,i);
    chain.Add(inname);
    cout << "File " << inname << " added to chain." << endl;
  }

  TString inZjets = TString::Format("%.9s",inFile);
  if( std::strcmp(inZjets,"bkg_Zjets") == 0 ){
    for (Int_t i = 11; i <= 100; i++){
      inname.Form("/eos/infnts/atlas/giuliac/condor/20250717_Task27/root_outputs/50K_%s_%d.root",inFile,i);
      chain.Add(inname);
      cout << "File " << inname << " added to chain." << endl;
    }
  ...
  // For Chi2 and CL limits calculation

  std::vector<TH1F*> Chi2_Invmass_2small;
  std::vector<TH2F*> Chi2HD_PTF1s_PTF2s;
  std::vector<TH2F*> Chi2LD_PTF1s_PTF2s;
  ...
  for(Int_t i = 0; i < cat.size(); ++i){
    ...
    if(i==0){
      Chi2_Invmass_2small.push_back(new TH1F("Chi2" + cat.at(i) + "Invariant_mass_of_leading_and_subleading_small_jets", "", 15, 20.0, 80.0));
    }else if(i==1){
      Chi2_Invmass_2small.push_back(new TH1F("Chi2" + cat.at(i) + "Invariant_mass_of_leading_and_subleading_small_jets", "", 30, 30.0, 150.0));
    }

    Chi2LD_PTF1s_PTF2s.push_back(new TH2F("Chi2LD" + cat.at(i) + "PTF1small_vs_PTF2small", "", 10, 0.0, 1.0, 10, 0.0, 1.0));
    Chi2HD_PTF1s_PTF2s.push_back(new TH2F("Chi2HD" + cat.at(i) + "PTF1small_vs_PTF2small", "", 20, 0.0, 1.0, 20, 0.0, 1.0));
  ...
  for(Int_t entry = 0; entry < numberOfEntries; ++entry)
  {
    ...
    treeReader->ReadEntry(entry);
     ...
     //------------------ Selection: CUT4 DeltaR vs mjj of first 2 Small Jets --------------------

     if( (n_largejets == 1) & ( DeltaR(smalljet1, smalljet2) > -0.09 * (*smalljet1P4 + *smalljet2P4).M() + 8.5) ) continue;

     //------------------ End of Selection: CUT4 DeltaR vs mjj of first 2 Small Jets --------------------
     ...
     //------------------ Selection: CUT4 ECF2/pT of Leading Large Jet --------------------

     if( (n_largejets >= 2) & ( ECF2(treeReader, entry, branchTrack, largejet1) / largejet1->PT <= 2 ) ) continue;

     //------------------ End of Selection: CUT4 ECF2/pT of Leading Large Jet --------------------
     ...
     if(n_largejets == 1){
       ...
       Chi2_Invmass_2small.at(0)->Fill( (*smalljet1P4 + *smalljet2P4).M()  );
       ...
       Chi2LD_PTF1s_PTF2s.at(0)->Fill( PTFsmall(treeReader, entry, branchTrack, smalljet1, zPV) , PTFsmall(treeReader, entry, branchTrack, smalljet2, zPV) );
       Chi2HD_PTF1s_PTF2s.at(0)->Fill( PTFsmall(treeReader, entry, branchTrack, smalljet1, zPV) , PTFsmall(treeReader, entry, branchTrack, smalljet2, zPV) );
       ...
       Chi2_Invmass_2small.at(1)->Fill( (*smalljet1P4 + *smalljet2P4).M()  );
       ...
       Chi2LD_PTF1s_PTF2s.at(1)->Fill( PTFsmall(treeReader, entry, branchTrack, smalljet1, zPV) , PTFsmall(treeReader, entry, branchTrack, smalljet2, zPV) );
       Chi2HD_PTF1s_PTF2s.at(1)->Fill( PTFsmall(treeReader, entry, branchTrack, smalljet1, zPV) , PTFsmall(treeReader, entry, branchTrack, smalljet2, zPV) );
...
*/
  ...
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250718_Task27/" ;

  TString outnametxt;
  outnametxt.Form(outdir + "NofEv_%s.txt",inFile);

  ofstream outtextfile;
  outtextfile.open(outnametxt);
  outtextfile << "This file contains Number of Events passing final selection for sample " << inFile << endl;
  outtextfile << "" << endl;
...
//-------------------------------------------------------
  ...
  TString outname;
  outname.Form(outdir + "%s.root",inFile);
  ...
  for(Int_t i = 0; i < cat.size(); ++i){
    ...
    Chi2_Invmass_2small.at(i)->Write("",TObject::kOverwrite);
    Chi2LD_PTF1s_PTF2s.at(i)->Write("",TObject::kOverwrite);
    Chi2HD_PTF1s_PTF2s.at(i)->Write("",TObject::kOverwrite);
