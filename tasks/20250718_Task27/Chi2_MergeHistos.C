...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250718_Task27/Chi2_MergeHistos.C 
...
void Chi2_MergeHistos()
{
  ...
  for(Int_t i = 0; i < cat.size(); ++i){
    Chi2CL2D(infiles,"Chi2LD" + cat.at(i) + "PTF1small_vs_PTF2small",xsec_s1,xsec,ntot,lumi,leglimits_2,"PTF of L vs Subl Small Jet",cat.at(i) + "PTF1S_PTF2S" + "_LD", dir);
    Chi2CL2Dsys(infiles,f_sys,systag,"Chi2LD" + cat.at(i) + "PTF1small_vs_PTF2small",xsec_s2,xsec,ntot,lumi,leglimits_4,"PTF of L vs Subl Small Jet",cat.at(i) + "PTF1S_PTF2S" + "_LD",dir);
  }
