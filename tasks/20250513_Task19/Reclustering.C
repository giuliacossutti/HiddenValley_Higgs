...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250513_Task19/Reclustering.C'("/gfsvol01/atlas/giuliac/condor/20250513_Task19/50K_signal_EJ.root","signal_EJ",kTRUE)'
*/
...
void Reclustering(const char *inputFile, const char * outFile,Bool_t Norm=kFALSE)
{
  ...
  // Output name:
  TString outfolder;
  outfolder.Form("/gfsvol01/atlas/giuliac/plots_and_outputs/20250513_Task19/%s_",outFile);
