...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/BuildHistos.C'("signal_EJ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/BuildHistos.C'("bkg_ZZ")' &
...
*/
  ...
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250705_Task24/" ;

  TString outnametxt;
  outnametxt.Form(outdir + "afterCut4_%s.txt",inFile);
