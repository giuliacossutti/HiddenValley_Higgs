...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/FigureOfMerit_final.C 
...
void FigureOfMerit_final()
{

  // Open histograms' file
  TString filename = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250705_Task24/area_MergedHistos.root";

  TFile *infile = new TFile(filename);

  // Output directory
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250705_Task24/FinalSignalRegion_";
