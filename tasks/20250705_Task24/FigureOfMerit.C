...
root -l /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250705_Task24/FigureOfMerit.C 
...
void FigureOfMerit()
{
  ...
  TString filename = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250705_Task24/area_ZZHZ_MergedHistos.root";

  TFile *infile = new TFile(filename);

  // Output directory
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250705_Task24/ZZHZ_Cut5_";
