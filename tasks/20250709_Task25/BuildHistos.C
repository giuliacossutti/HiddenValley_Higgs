...
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250709_Task25/BuildHistos.C'("signal_EJ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250709_Task25/BuildHistos.C'("bkg_Zjets_q")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250709_Task25/BuildHistos.C'("bkg_Zjets_g")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250709_Task25/BuildHistos.C'("bkg_ZZ")' &
root -l -q /gfsvol01/atlas/giuliac/HiddenValley_Higgs/tasks/20250709_Task25/BuildHistos.C'("bkg_HZ_SM")' &
...
*/
      ...
      inname.Form("/eos/infnts/atlas/giuliac/condor/20250709_Task25/root_outputs/test50K_%s_%d.root",inFile,1);
      chain.Add(inname);
      cout << "File " << inname << " added to chain." << endl;
...
*/
  ...
  //TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250709_Task25/" ;
  TString outdir = "/gfsvol01/atlas/giuliac/plots_and_outputs/20250709_Task25/test_" ;

  TString outnametxt;
  outnametxt.Form(outdir + "pTHatMin_%s.txt",inFile);
